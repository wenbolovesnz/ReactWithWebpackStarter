...
const OrderSection = React.createClass({
	...
	render(){
			return <div>
				...
				<div className="row">
					<Summary beef={this.props.value.beef} chicken={this.props.value.chicken} veg={this.props.value.veg} alfa={this.props.value.alfa}  isSubmitting= {this.props.value.isSubmitting}
